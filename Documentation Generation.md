...
2. **🏗️ Architecture / Design:** (Structure and data flow)
3. **🔧 Code Breakdown:** (Key functions and classes)
4. **⚙️ Setup & Installation:** (How to run it)
5. **▶️ Usage Examples:** (Code snippets for execution)
6. **⚠️ Error Handling & 🧪 Edge Cases:** (Failure paths)
...
Strong documentation follows this flow:
**Understand → Structure → Explain Clearly → Guide Usage → Improve Clarity**

---

## 📌 Usage Tips

* **Best For:** APIs, backend services, utility libraries, and full-stack project files.
* **Context is King:** Always include the full code context (and any relevant JSON schemas or DB models) for the best results.
* **The Golden Loop:** Combine this with your Refactor and Debug templates! First fix the code, then refactor it, then document the clean version.
